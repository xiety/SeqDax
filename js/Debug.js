define(["exports", "fable-core", "./Axapta"], function (exports, _fableCore, _Axapta) {
  ...
  function reverse(root, ax) {
    var mapLine = function mapLine(a) {
      var tmp = _fableCore.List.ofArray([root, root], _fableCore.List.reverse(a));
      ...
      }, _fableCore.Seq.toList(_fableCore.Seq.skip(1, _fableCore.Seq.toList(_fableCore.Seq.pairwise(tmp)))));
    };
