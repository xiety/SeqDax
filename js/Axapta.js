define(["exports", "fable-core", "./Utils"], function (exports, _fableCore, _Utils) {
  ...
  exports.AxCallstackItem = undefined;
  ...
  function parse(items) {
    var regex = function regex(s) {
      var activePatternResult95 = (0, _Utils.$Regex$_$)("^\\[[sc]\\]\\s+(.*?)\\s+(\\d+)$", s);

      if (activePatternResult95 != null) {
        var a = activePatternResult95;
  ...
  function parseAxCallstack(text) {
    ...
    }, _fableCore.List.ofArray(_fableCore.String.split(text, ["\n"], null, 0).filter(function ($var2) {
